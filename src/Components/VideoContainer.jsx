...
const VideoContainer = () => {
  ...
  if (mainMovieTrailerData && mainMovieTrailerData.length > 0) {
    ...
    link = `https://www.youtube.com/embed/${key}?rel=0&autoplay=1&controls=0`; // Properly formatted link
  }

  return (
    <div className='w-full bg-slate-700 h-full relative'>
      <iframe width="560" height="315" src={link} title="youtube embed" allow="autoplay" className='w-full h-full'></iframe>
